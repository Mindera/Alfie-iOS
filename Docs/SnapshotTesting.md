...
| `ScannerViewSnapshotTests` | `ScannerTests` | Scanner chrome over the camera, wrapping guidance, an unrecognised-code notice, permission denied, device unsupported |
