...
public final class WebViewModel2: WebViewModelProtocol2 {
    private let webFeature: WebFeature?
    private let url: URL?
    public let title: String
    private let dependencies: WebDependencyContainer2
    @Published public private(set) var state: WebViewState2 = .empty
