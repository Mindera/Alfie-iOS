...
#Preview(body: {
    Text.build(
        DesignSystem.shared.font.body.small(Array(repeating: "Hello, world!", count: 24).joined(separator: " "))
    )
    .shimmeringMultiline(while: .constant(true), lines: 8, font: DesignSystem.shared.font.body.small.uiFont)
