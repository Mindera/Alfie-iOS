...
struct ProductListingFilter2: View {
    @State private var sort: SortByType
    @Binding private var listStyle: ProductListingListStyle2
    ...
    init(
        ...
        listStyle: Binding<ProductListingListStyle2>,
    ...
    var listStyleView: some View {
        HStack {
            ...
            Spacer()
            ProductListingListStyleSelector2(selectedStyle: $listStyle)
        }
