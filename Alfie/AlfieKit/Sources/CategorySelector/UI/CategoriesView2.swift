...
struct CategoriesView2<ViewModel: CategoriesViewModelProtocol>: View {
...
#Preview("Loading") {
    CategoriesView2(viewModel: MockCategoriesViewModel(state: .loading, categories: NavigationItem.fixtures))
}

#Preview("Error") {
    CategoriesView2(viewModel: MockCategoriesViewModel(state: .error(.generic)))
}
#endif
