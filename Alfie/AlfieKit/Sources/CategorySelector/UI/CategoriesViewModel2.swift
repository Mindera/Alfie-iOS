...
final class CategoriesViewModel2: CategoriesViewModelProtocol {
    ...
    func didSelectCategory(_ category: NavigationItem) {
        ...
        if let specialCategory = SpecialCategories.allCases.first(
            ...
            guard !ignoreLocalNavigation, let url = ThemedURL2.services.internalUrl else { return }
        ...
        guard
            var url = URL(string: "https://\(ThemedURL2.hostWithPortComponent)"),
