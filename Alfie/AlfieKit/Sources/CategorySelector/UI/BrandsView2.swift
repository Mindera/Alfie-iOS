...
struct BrandsView2<ViewModel: BrandsViewModelProtocol>: View {
...
extension BrandsView2 {
    ...
    struct BrandItemView: View, Equatable {
        ...
        static func == (lhs: BrandsView2<ViewModel>.BrandItemView, rhs: BrandsView2<ViewModel>.BrandItemView) -> Bool {
            lhs.brand == rhs.brand
        }
    }
...
#Preview("Loading") {
    ...
    return BrandsView2(viewModel: viewModel)
}

#Preview("Error") {
    BrandsView2(viewModel: MockBrandsViewModel(state: .error(.generic)))
}
#endif
