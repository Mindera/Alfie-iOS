...
public extension BFFGraphAPI {
  class UpdateCartMutation: GraphQLMutation {
    public static let operationName: String = "UpdateCartMutation"
    public static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"mutation UpdateCartMutation($input: UpdateCartInput!) { updateCart(input: $input) { __typename ...CartFragment } }"#,
    ...
    public struct Data: BFFGraphAPI.SelectionSet {
      ...
      public static var __selections: [ApolloAPI.Selection] { [
        .field("updateCart", UpdateCart.self, arguments: ["input": .variable("input")]),
      ] }

      public var updateCart: UpdateCart { __data["updateCart"] }

      /// UpdateCart
      ///
      /// Parent Type: `Cart`
      public struct UpdateCart: BFFGraphAPI.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }
