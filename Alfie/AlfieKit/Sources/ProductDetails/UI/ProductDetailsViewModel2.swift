...
public final class ProductDetailsViewModel2: ProductDetailsViewModelProtocol2 {
    private let dependencies: ProductDetailsDependencyContainer2
    ...
    @Published public private(set) var state: ViewState<ProductDetailsViewStateModel2, ProductDetailsViewErrorType2> = .loading
    ...
    public var complementaryInfoToShow: [ProductDetailsComplementaryInfoType2] {
    ...
    public var shareConfiguration: ShareConfiguration? {
        ...
        guard let url = dependencies.webUrlProvider.url(for: ProductURL2(slug: product.slug)) else {
            return nil
        }
    ...
    public init(
        productId: String,
        product: Product?,
        dependencies: ProductDetailsDependencyContainer2,
    ...
    public func shouldShowLoading(for section: ProductDetailsSection2) -> Bool {
        switch section {
        case .titleHeader:
    ...
    public func shouldShow(section: ProductDetailsSection2) -> Bool {
    ...
    public func complementaryInfoWebFeature(for type: ProductDetailsComplementaryInfoType2) -> WebFeature? {
        // swiftlint:disable vertical_whitespace_between_cases
        switch type {
        case .delivery:
            return nil
