...
public struct ProductDetailsView2<ViewModel: ProductDetailsViewModelProtocol2>: View {
    ...
    private func shimmeringBinding(for section: ProductDetailsSection2) -> Binding<Bool> {
    ...
    private func complementaryInfoTitle(for type: ProductDetailsComplementaryInfoType2) -> String {
...
extension ProductDetailsView2 {
    ...
    private var sizeSheet: some View {
        ProductDetailsColorAndSizeSheet2(viewModel: viewModel, type: .size, isPresented: $showSizeSheet)
    }
    ...
    private func complementaryInfoCell(type: ProductDetailsComplementaryInfoType2, showTopDivider: Bool) -> some View {
        VStack(spacing: Spacing.space0) {
            if showTopDivider {
