...
struct AccountSectionView2: View {
    private var section: AccountSection2
    private var hiddenDividerTop: Bool
    private var hiddenDividerBottom: Bool

    init(for section: AccountSection2, hiddenDividerTop: Bool = false, hiddenDividerBottom: Bool = false) {
...
#Preview {
    AccountSectionView2(for: .myDetails)
}
