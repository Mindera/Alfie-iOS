...
struct RecentSearchesView2<ViewModel: RecentSearchesViewModelProtocol2>: View {
...
//#if DEBUG
//#Preview {
//    RecentSearchesView2(viewModel: RecentSearchesViewModel(recentsService: MockRecentsService()))
//}
//#endif
