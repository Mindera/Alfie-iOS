...
public struct SuggestionProductFragment: BFFGraphApi.SelectionSet, Fragment {
  ...
  public struct Medium: BFFGraphApi.SelectionSet {
    ...
    public struct AsVideo: BFFGraphApi.InlineFragment, ApolloAPI.CompositeInlineFragment {
      ...
      public var sources: [MediaFragment.AsVideo.Source] { __data["sources"] }
