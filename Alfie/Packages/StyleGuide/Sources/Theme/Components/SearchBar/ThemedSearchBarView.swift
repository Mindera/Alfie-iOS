...
public struct ThemedSearchBarView: View {
    ...
    @State private var text: String = "" // We cannot use the binding above otherwise it won't trigger the onChange if used outside a view
        ...
        HStack {
            ...
            HStack {
                TextField("",
                    ...
                    .onAppear {
                        guard case .on(let delay) = autoFocusWhenAppearing else {
                            return
                        }
            ...
            .background(
                ZStack {
                    ...
                    RoundedRectangle(cornerRadius: CornerRadius.full)
                        ...
                        .stroke(isFocused ? theme.focusedBorderColor : theme.unfocusedBorderColor,
    ...
    @ViewBuilder
    private var textFieldOverlayIcon: some View {
