    ...
    public static func fixtures(includeMedia: Bool) -> [Product] {
        if includeMedia {
            ...
            fixtures.map { fixture in
                Product(styleNumber: fixture.styleNumber,
                        name: fixture.name,
                        brand: fixture.brand,
                        shortDescription: fixture.shortDescription,
                        slug: fixture.shortDescription,
                        defaultVariant: Product.Variant(sku: fixture.defaultVariant.sku,
...
extension Product {
    ...
    public static let necklace = Product(
        ...
        shortDescription: "The Sardinia Necklace by Amber Sceats boasts a modern silhouette, featuring polished 24K Gold plated teardrop pendants.",
    ...
    private static let necklaceColor: Product.Colour = .init(
        ...
        media: [
            .image(MediaImage(
                ...
                url: URL(string: "https://www.alfieproj.com/productimages/medium/1/2627014_22646926_13567396.jpg")!)),
        ])
    ...
    public static let blazer = Product(
        ...
        shortDescription: "This double-breasted june blazer in blue is crafted from a tencel blend for enhanced durability and a soft woven texture.",
    ...
    private static let blazerColor: Product.Colour = .init(
        ...
        media: [
            .image(MediaImage(
                alt: nil,
                mediaContentType: .image,
                url: URL(string: "https://www.alfieproj.com/productimages/medium/1/2641917_22732293_13656033.jpg")!)),
        ])
    ...
    public static let dress = Product(
        ...
        shortDescription: "This midi length shirt dress features a tie waist, voluminous skirt and full button down placket.",
    ...
    private static let dressColor: Product.Colour = .init(
        ...
        media: [
            .image(MediaImage(
                alt: nil,
                mediaContentType: .image,
                url: URL(string: "https://www.alfieproj.com/productimages/medium/1/2612578_22583503_13491037.jpg")!)),
        ])
    ...
    public static let hat = Product(
        ...
        longDescription: "An essential storytelling element of the Cruise 2024 collection, the 'Gucci Made in Italy' print defines this beige canvas baseball hat with a light brown leather trim.",
        slug: "gucci-baseball-hat-with-gucci-print-26626706",
        priceRange: .init(low: .init(currencyCode: "AUD",
                                     amount: 75000,
                                     amountFormatted: "$750.00"),
                          high: .init(currencyCode: "AUD",
                                      amount: 85000,
    ...
    private static let hatColor: Product.Colour = .init(
        ...
        media: [
            .image(MediaImage(
                alt: nil,
                mediaContentType: .image,
                url: URL(string: "https://www.alfieproj.com/productimages/medium/1/2657108_22804950_13918038.jpg")!)),
        ])
    ...
    public static let neckDress = Product(
        ...
        shortDescription: "Introducing our stylish Admiral Crepe Funnel Neck Dress, the epitome of chic and contemporary elegance.",
    ...
    private static let neckDressColor: Product.Colour = .init(
        ...
        media: [
            .image(MediaImage(
                alt: nil,
                mediaContentType: .image,
                url: URL(string: "https://www.alfieproj.com/productimages/medium/2/2584579_22478962_13351997.jpg")!)),
        ])
    ...
    private static let neckDressVariant: Product.Variant = .init(
        ...
        price: .init(amount: .init(currencyCode: "AUD",
                                   amount: 47500,
                                   amountFormatted: "$475.00"),
                     was: .init(currencyCode: "AUD",
                                amount: 57000,
                                amountFormatted: "$570.00")))
    ...
    public static let sandal = Product(
        ...
        shortDescription: "Alias Mae Verona sandal in natural raffia with chunky sole, crossover vamp and ankle strap with buckle.",
    ...
    private static let sandalColor: Product.Colour = .init(
        ...
        media: [
            .image(MediaImage(
                alt: nil,
                mediaContentType: .image,
                url: URL(string: "https://www.alfieproj.com/productimages/medium/1/2593051_22512791_12951251.jpg")!)),
        ])
    ...
    private static let jacketColor: Product.Colour = .init(
        ...
        media: [
            .image(MediaImage(
                alt: nil,
                mediaContentType: .image,
                url: URL(string: "https://www.alfieproj.com/productimages/medium/1/2657932_22808834_13869761.jpg")!)),
        ])
