...
struct ModalDemoView: View {
    ...
    var body: some View {
        ...
        .modalView(isPresented: $isPresentedSmall, title: "Size Guide", content: {
            smallBody
        })
        .modalView(isPresented: $isPresentedBig, title: "Size Guide", content: {
            bigBody
        })
    }
    ...
    private var smallBody: some View {
        VStack(alignment: .leading) {
            ...
            Text.build(theme.font.paragraph.boldItalic("• Waist"))
                .padding(.bottom, Spacing.space050)
            Text.build(theme.font.paragraph.normal("The slimmest part of your natural waistline, above your navel and below your ribcage."))
                .padding(.bottom, Spacing.space100)
            Text.build(theme.font.paragraph.boldItalic("• Hip"))
                .padding(.bottom, Spacing.space050)
            Text.build(theme.font.paragraph.normal("Measure around the widest point of your hips, at the top of your legs."))
                .padding(.bottom, Spacing.space100)
        }
    }
    ...
    private var bigBody: some View {
        VStack(alignment: .leading) {
            ...
            Text.build(theme.font.paragraph.boldItalic("• Waist"))
                .padding(.bottom, Spacing.space050)
            Text.build(theme.font.small.normal("The slimmest part of your natural waistline, above your navel and below your ribcage."))
                .padding(.bottom, Spacing.space100)
            Spacer().frame(height: 400)
            Text.build(theme.font.paragraph.boldItalic("• Hip"))
                .padding(.bottom, Spacing.space050)
            Text.build(theme.font.small.normal("Measure around the widest point of your hips, at the top of your legs."))
                .padding(.bottom, Spacing.space100)
        }
    }
}
