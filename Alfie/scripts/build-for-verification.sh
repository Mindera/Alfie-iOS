...
# Check if it was a destination error (exit code 70 or specific error message)
if grep -q "Unable to find a device matching the provided destination" /tmp/alfie_build.log; then
